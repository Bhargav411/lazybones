...
props.usingServices = askBoolean("Create Java Services? [yes]: ", "yes", "usingServices")
if (usingServices) {
    props.services = ask("Folder name under /Services for components and templates [${defaultFolderName}]: ", defaultFolderName, "services")
}

props.usingServlets = askBoolean("Create Java Servlets? [yes]: ", "yes", "usingServlets")

if(usingServlets){
    props.servlets = ask("Folder name under /Servlets for components and templates [${defaultFolderName}]: ", defaultFolderName, "servlets")
}
...
def servicesDir = new File(projectDir, "core/src/main/java/${props.services}")
servicesDir.mkdirs()

def servletsDir = new File(projectDir, "core/src/main/java/${props.servlets}")
servletsDir.mkdirs()
